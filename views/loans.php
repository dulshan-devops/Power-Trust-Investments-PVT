				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id  order by id asc");
...
<script>
	...
	$('#new_application').click(function(){
		uni_modal("New Loan Application","manage_loan.php",'mid-large modal-dialog-scrollable')
	})
	$('.edit_loan').click(function(){
		uni_modal("Edit Loan","manage_loan.php?id="+$(this).attr('data-id'),'mid-large modal-dialog-scrollable')
	})
