            ...
            <div class="card-body">
                <table class="table-striped table-bordered col-md-12">
                    ...
                    <tbody>
                        ...
                        $loan_list = $conn->query("SELECT  * from borrowers INNER JOIN  loan_list on borrowers.id=loan_list.borrower_id where loan_list.status = 0;");
                        $i = 1;
                        ...
                        ?>
                            <tr>
                                ...
                                <td>
                                    <center>
                                        <button type="button" class="btn btn-primary btn-sm" id="view_application" onclick="view_modal(<?php echo $row['ref_no'] ?>)" data-toggle="modal" data-target="#view_application_modal">View Application</button>
                                    </center>
                                </td>
                            </tr>
                        <?php endwhile; ?>
